...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gboxAnalyse.sizePolicy().hasHeightForWidth())
        self.gboxAnalyse.setSizePolicy(sizePolicy)
        self.gboxAnalyse.setMinimumSize(QtCore.QSize(140, 0))
        self.gboxAnalyse.setMaximumSize(QtCore.QSize(16777215, 16777215))
