...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pbtnSetWT = QtWidgets.QPushButton(self.gboxAnalyseThresh)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pbtnSetWT.sizePolicy().hasHeightForWidth())
        self.pbtnSetWT.setSizePolicy(sizePolicy)
        self.pbtnSetWT.setObjectName("pbtnSetWT")
        self.horizontalLayout_xstart_2.addWidget(self.pbtnSetWT)
        self.pbtnChkWT = QtWidgets.QPushButton(self.gboxAnalyseThresh)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pbtnChkWT.sizePolicy().hasHeightForWidth())
        self.pbtnChkWT.setSizePolicy(sizePolicy)
        self.pbtnChkWT.setObjectName("pbtnChkWT")
        self.horizontalLayout_xstart_2.addWidget(self.pbtnChkWT)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pbtnSetWT.setText(_translate("MainWindow", "Set"))
        self.pbtnChkWT.setText(_translate("MainWindow", "Check"))
